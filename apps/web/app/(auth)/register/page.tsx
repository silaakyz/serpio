    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-xl font-semibold" style={{ color: "#E2E8F0" }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-sm font-medium mb-1.5" style={{ color: "#E2E8F0" }}>
              Ad Soyad
            </label>
            <input
              id="name"
          ...
          <div>
            <label htmlFor="email" className="block text-sm font-medium mb-1.5" style={{ color: "#E2E8F0" }}>
              E-posta
            </label>
            <input
              id="email"
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium mb-1.5" style={{ color: "#E2E8F0" }}>
              Şifre
            </label>
            <input
              id="password"
        ...
        {/* Trust signals */}
        <div className="flex items-center justify-center gap-4 mt-4 text-xs" style={{ color: "#334155" }}>
